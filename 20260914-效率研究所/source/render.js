...
const covers = [
  {
    ...
    svg: shell(1, '#2f7d52', `
      ...
      ${toolIcon(140, 885, 130, 'GPT', '#1f8f64')}
      ${toolIcon(330, 885, 130, 'G', '#7657d6')}
      ${toolIcon(520, 885, 130, 'P', '#2877d5')}
      ${toolIcon(710, 885, 130, 'GN', '#db8e24')}
      ${toolIcon(900, 885, 130, 'C', '#1d9faa')}
  ...
  },
  {
    file: '02-chatgpt.png',
    svg: toolPage(2, {
      name: 'ChatGPT', icon: 'GPT', accent: '#1f8f64', kicker: '综合型 AI 助手',
  ...
  },
  {
    ...
    svg: toolPage(4, {
      name: 'Perplexity', icon: 'P', accent: '#2877d5', kicker: '联网查资料',
  ...
  },
  {
    ...
    svg: shell(7, '#2f7d52', `
      ...
      ${toolIcon(138, 570, 84, 'GPT', '#1f8f64')}${text(260, 623, '综合沟通', 32, 750, '#1f2923')}${text(1035, 623, 'ChatGPT', 31, 650, '#1f8f64', 'end')}
      <line x1="138" y1="682" x2="1062" y2="682" stroke="#e7ece8" stroke-width="2"/>
      ${toolIcon(138, 705, 84, 'G', '#7657d6')}${text(260, 758, 'Google 生态', 32, 750, '#1f2923')}${text(1035, 758, 'Gemini', 31, 650, '#7657d6', 'end')}
      <line x1="138" y1="817" x2="1062" y2="817" stroke="#e7ece8" stroke-width="2"/>
      ${toolIcon(138, 840, 84, 'P', '#2877d5')}${text(260, 893, '联网查资料', 32, 750, '#1f2923')}${text(1035, 893, 'Perplexity', 31, 650, '#2877d5', 'end')}
      <line x1="138" y1="952" x2="1062" y2="952" stroke="#e7ece8" stroke-width="2"/>
      ${toolIcon(138, 975, 84, 'GN', '#db8e24')}${text(260, 1028, '围绕资料学习', 32, 750, '#1f2923')}${text(1035, 1028, 'Gemini Notebook', 30, 650, '#db8e24', 'end')}
      <line x1="138" y1="1087" x2="1062" y2="1087" stroke="#e7ece8" stroke-width="2"/>
      ${toolIcon(138, 1110, 84, 'C', '#1d9faa')}${text(260, 1163, '视觉内容初稿', 32, 750, '#1f2923')}${text(1035, 1163, 'Canva AI', 31, 650, '#1d9faa', 'end')}
